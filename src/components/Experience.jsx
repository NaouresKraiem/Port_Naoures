            ...
            <div className="space-y-8">
                ...
                experiences.map((exp, index) => (
                    <div key={index}
                        ...
                        <div className="absolute -left-2 top-0 w-4 h-4 bg-primary-600 rounded-full border-4 border-white shadow-lg animate-pulse-slow"></div>
                        <div className="bg-gradient-to-br from-gray-50 to-primary-50 rounded-xl p-6 shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-x-2 border border-primary-100">
                            <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4 gap-4">
                                <div className="flex items-start gap-4 flex-1">
                                    {/* Company Logo */}
                                    <div className="flex-shrink-0">
                                        <div className="w-16 h-16 rounded-lg bg-white p-2 shadow-sm border border-gray-200 flex items-center justify-center overflow-hidden">
                                            <img 
                                                src={exp.logo} 
